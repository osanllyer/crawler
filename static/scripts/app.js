...
angular
  .module('sbAdminApp', [
    ...
    'angular-loading-bar',
    'ui.grid',
    'ui.grid.edit', 'ui.grid.cellNav','ui.grid.pagination','ui.grid.rowEdit'
  ])
  .config(['$stateProvider','$urlRouterProvider','$ocLazyLoadProvider',function ($stateProvider,$urlRouterProvider,$ocLazyLoadProvider) {
    ...
    $stateProvider
      ...
      .state('dashboard.grid',{
       ...
       url:'/grid'
   }).state('dashboard.questioneditor', {
	   //题库编辑
	   url : '/questioneditor',
	   templateUrl : 'views/libman/questioneditor.html',
	   controller : 'QuestionEditorCtrl',
	   resolve : {
		   loadMyFile:function($ocLazyLoad) {
	           $ocLazyLoad.load({
	               name:'sbAdminApp',
	               files:['scripts/controllers/controller-questioneditor.js']
	           })
		   }
	   }
   })
